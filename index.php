        ...
        <div class="row">
            ...
            <div class="col-3">
                <div class="card" style="width: 18rem;">
                    ...
                    <div class="card-body">
                        <h5 class="card-title"> <?php echo $cibo_1-> getNome(); ?></h5>
                        <p class="card-text"><?php echo "Tipo: ".$cibo_1-> getTipo()." ".$cibo_1-> getCategoria(); ?></p>
                        <p class="card-text"><?php echo "Prezzo: ".$cibo_1->getPrezzo()."€"; ?></p>
                    </div>
                </div>
            </div>
            <div class="col-3">
                <div class="card" style="width: 18rem;">
                    ...
                    <div class="card-body">
                        <h5 class="card-title"> <?php echo $cibo_2-> getNome(); ?></h5>
                        <p class="card-text"><?php echo "Tipo: ".$cibo_2-> getTipo()." ".$cibo_2-> getCategoria(); ?></p>
                        <p class="card-text"><?php echo "Prezzo: ".$cibo_2->getPrezzo()."€"; ?></p>
            ...
            <div class="col-3">
                <div class="card" style="width: 18rem;">
                    ...
                    <div class="card-body">
                        <h5 class="card-title"> <?php echo $cibo_3-> getNome(); ?></h5>
                        <p class="card-text"><?php echo "Tipo: ".$cibo_3-> getTipo()." ".$cibo_3-> getCategoria(); ?></p>
                        <p class="card-text"><?php echo "Prezzo: ".$cibo_3->getPrezzo()."€"; ?></p>
            ...
            <div class="col-3">
                <div class="card" style="width: 18rem;">
                    ...
                    <div class="card-body">
                        <h5 class="card-title"> <?php echo $cibo_4-> getNome(); ?></h5>
                        <p class="card-text"><?php echo "Tipo: ".$cibo_4-> getTipo()." ".$cibo_4-> getCategoria(); ?></p>
                        <p class="card-text"><?php echo "Prezzo: ".$cibo_4->getPrezzo()."€"; ?></p>
